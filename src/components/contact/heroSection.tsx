  ...
  return (
    <section className="mt-14 md:mt-10 lg:mt-12 xl:mt-[68px] p-5 lg:p-7 xl:p-10 space-y-6 md:space-y-5 lg:space-y-6 xl:space-y-8 bg-[#f0fff4]">
      <div className=" text-center">
        ...
        <p className="pt-4 md:pt-2.5 xl:pt-4 text-base lg:text-lg xl:text-xl font-cabin text-[#333333] leading-6.5 md:leading-5.5 lg:leading-6 xl:leading-7.5 w-[90vw] md:w-[34vw] lg:w-[36vw] xl:w-[40vw] mx-auto">
      ...
      <div className="p-2 lg:p-3 xl:p-5  md:w-[83vw] mx-auto">
