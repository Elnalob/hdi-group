...
function HeroSection() {
  ...
  return (
    <section ref={container} className="bg-[#f0fff4] ">
      <div className="space-y-6 md:space-y-4 lg:space-y-6 xl:space-y-8 mt-14 md:mt-10 lg:mt-12 xl:mt-[68px] text-center p-5 lg:p-7 xl:p-10 2xl:container 2xl:mx-auto">
